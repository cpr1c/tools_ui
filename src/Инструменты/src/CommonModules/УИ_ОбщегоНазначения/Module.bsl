...
Функция ОписаниеТипаПоИдентификаторуТипа(ИдентификаторТипа) Экспорт
	СтрокаДляСериализации = ОписаниеТипаСериализованнаяСтрокаЗаголовок();
	ДобавитьКСериализованнойСтрокеОписанияТипаСтрокуТипа(СтрокаДляСериализации, ИдентификаторТипа);

	Возврат ЗначениеИзСтрокиXML(СтрокаДляСериализации + ОписаниеТипаСериализованнаяСтрокаПодвал());
...
Функция ОписаниеТипаЛюбаяСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("AnyRef");
КонецФункции
...
Функция ОписаниеТипаХарактиристикаПланаВидовХарактеристик(ИмяПланаВидовХарактеристик) Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("Characteristic." + ИмяПланаВидовХарактеристик);
КонецФункции
...
Функция ОписаниеТипаОпределяемогоТипа(ИмяОпределяемогоТипа) Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("DefinedType." + ИмяОпределяемогоТипа);
КонецФункции
...
Функция ОписаниеТипаСправочникСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("CatalogRef");
КонецФункции
...
Функция ОписаниеТипаДокументCсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("DocumentRef");
КонецФункции
...
Функция ОписаниеТипаБизнессПроцессCсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("BusinessProcessRef");
КонецФункции
...
Функция ОписаниеТипаТочкаМаршрутаБизнесПроцессаСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("BusinessProcessRoutePointRef");
КонецФункции
...
Функция ОписаниеТипаПланСчетовСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("ChartOfAccountsRef");
КонецФункции
...
Функция ОписаниеТипаПланВидовРасчетаСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("ChartOfCalculationTypesRef");
КонецФункции
...
Функция ОписаниеТипаПланВидовХарактеристикСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("ChartOfCharacteristicTypesRef");
КонецФункции
...
Функция ОписаниеТипаПеречислениеСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("EnumRef");
КонецФункции
...
Функция ОписаниеТипаПланОбменаСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("ExchangePlanRef");
КонецФункции
...
Функция ОписаниеТипаЗадачаСсылка() Экспорт
	Возврат ОписаниеТипаПоИдентификаторуТипа("TaskRef");
КонецФункции
...
Процедура ДобавитьКСериализованнойСтрокеОписанияТипаСтрокуТипа(СтрокаОписанияТипов, СтрокаТипа)
...
Функция ОписаниеТипаСериализованнаяСтрокаЗаголовок()
...
Функция ОписаниеТипаСериализованнаяСтрокаПодвал() 
