...
Процедура ЗаполнитьДинамическиеСвойстваЗначения(ИмяСвойства, ИменаСвойств, ЗначениеСтрокиДерева, ОбъектМД) Экспорт
...
Функция ИменаСвойствОписанияТипаПлатформы(ОписаниеТипаПлатформы, Значение, ОбъектМД) Экспорт
	...
	Для Каждого ТекСвойство Из ОписаниеТипаПлатформы.Свойства Цикл
		Если СтрНайти(ТекСвойство.Имя, "<") > 0 Тогда
			ЗаполнитьДинамическиеСвойстваЗначения(ТекСвойство.Имя, ИменаСвойств, Значение, ОбъектМД);
		Иначе
