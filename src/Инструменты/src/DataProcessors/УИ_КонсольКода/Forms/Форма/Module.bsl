...
//				Если СтрокаСвойства.ВидКонтейнера = ВидыКонтейнеров.Значение Тогда
//					ХранилищеДляПараметровФормы.Хранилище = СтрокаСвойства.Значение;
//				Иначе
...
//	КонецЕсли;
	...
	ПараметрыФормы.Вставить("Выражение", СтрокаПеременной.Имя);
...
Процедура ВыполнитьКодАлгоритма(Форма, Алгоритмы, ИдентификаторСтрокиАлгоритмов)
	...
	ПараметрыВыполненияАлгоритма.ВозвращатьЗначенияПеременных = Не СтрокаАлгоритма.НаКлиенте
																И Не СтрокаАлгоритма.ИспользоватьОбработкуДляВыполненияКода;
	...
	Если ПараметрыВыполненияАлгоритма.ВозвращатьЗначенияПеременных Тогда
		Форма.Элементы.ЗначенияПерменныхПослеВыполнения.Видимость = Истина;
