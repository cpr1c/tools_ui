...
Процедура ВыполнитьПриложение()
    ...
    КомандаЭкспортИсходниковEDT = Новый КомандаЭкспортИсходниковEDT;
    КомандаСборкиВРасширения = Новый КомандаСборкиВРасширения;
    
    Приложение = Новый КонсольноеПриложение("cli", "Сборщик проекта в бинарники", ЭтотОбъект);
    Приложение.Версия("v version","2.0");
    
    Приложение.ДобавитьКоманду("xml exportEDT", "Экспорт исходников в формат XML", КомандаЭкспортИсходниковEDT);
    Приложение.ДобавитьКоманду("cfe buildCFE", "Сборка расширений", КомандаСборкиВРасширения);
