...
Процедура ВыполнитьПриложение()
    ...
    Приложение.Опция("platformSource", "C:\Program Files\1cv8\8.3.14.2095\bin", "Каталог установки платформы для выполнения сборки");
    Приложение.Опция("edtSource", "C:\Program Files\1C\1CE\components\1c-edt-2024.1.3+13-x86_64\", "Каталог расположения исполняемых файлов EDT");
